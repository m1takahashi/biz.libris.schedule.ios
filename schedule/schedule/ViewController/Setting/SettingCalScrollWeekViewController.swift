//
//  SettingCalScrollWeekViewController.swift
//

import UIKit

class SettingCalScrollWeekViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = NSLocalizedString("setting_cal_scroll_week", comment: "")
    ...
    override func viewWillDisappear(animated: Bool) {
        UDWrapper.setInt(UDWrapperKey.UDWrapperKeyScrollDirectionWeek.rawValue, value: scrollDirection)
